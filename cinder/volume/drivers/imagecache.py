...
class ImageCache(object):
    ...
    def _convert_image(image_path, destination_path,
                       image_format, image_subformat):
    ...
    def _handle_requested_image(self, fetch_path, destination_path,
        ...
        self._resize_image_if_needed(destination_path, image_size)
    ...
    def _resize_image_if_needed(self, image_path, requested_size):
        ...
        elif requested_size > image_size:
            self._resize_image(image_path, requested_size)

    def _resize_image(self, image_path, new_size):
        image_utils.resize_image(image_path, new_size >> 30)
